...
import { allBlogsConstroller, createController, deleteBlogController, latestCacheBlogController, myBlogsController, paginationBlogController, updateBlogController, viewBlogController } from "../controllers/blog.controller";
...
blogrouter.get("/latest", latestCacheBlogController)
